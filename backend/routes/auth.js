...
router.post('/register', async (req, res, next) => {
    ...
    try {
        ...
        // Convert goal and activityLevel strings to numbers
        // const parsedGoal = parseFloat(goal);
        const parsedActivityLevel = parseFloat(activityLevel);

        // if (isNaN(goal) || isNaN(parsedActivityLevel)) {

        //     console.log(goal);
        //     console.log(parsedActivityLevel);
        //     return res.status(400).json(createResponse(false, 'Invalid goal or activityLevel'));
        // }
